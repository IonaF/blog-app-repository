...
function($scope, commentFactory){
  ...
  $scope.comments1 = [
	{
		commentTxt : "Good read. Liked the pictures a lot.",
		by : "Iona",
		on : "May 05, 2016 09:30 PM"
	},
	{
		commentTxt : "Very informative article.",
		by : "Anonymous",
		on : "May 04, 2016 10:30 AM"
	}
  ];
  $scope.addComment = function(){
	if(!$scope.newComment || $scope.newComment === '') { return; }
	$scope.comments.push({
		commentTxt : $scope.newComment,
		by : 'Anonymous',
		on : Date.now()
	});
	$scope.newComment = '';
