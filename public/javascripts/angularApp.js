...
function($scope, commentFactory){
  ...
  $scope.addComment = function(){
	...
	commentFactory.addComment(comment).success(function(comment) {
		//$scope.comments.push(comment);
	});
	$scope.newComment = '';
  };
